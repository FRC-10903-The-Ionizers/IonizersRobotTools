...
public class DriveSubsystem extends SubsystemBase {
  ...
  // SwerveBot07 (Grey Robot new design Old Motors)
  ...
  // private final boolean k_invertGyro = false;
  // private final double k_turnDeadZone = 3;
  // private final double k_turnP = 1.0 / 180.0;
  // private final double k_cameraAngle = 0;
  // private final double k_wheelSeparation = (7.406 * 2.54) / 100;
  // private final double k_driveBaseRadius = Math.sqrt(k_wheelSeparation *
  // k_wheelSeparation);
  // static final double k_ticksPerMeter = 1037.75 / 1.72;

  // private final Translation2d m_frontLeftLocation = new
  // Translation2d(k_wheelSeparation / 2, k_wheelSeparation / 2);
  ...
  // private static final double k_frontLeftMinSteeringPower = 0.36;
  ...
  // //0.92 / k_maxDriveSpeed;
  // private static final double k_backLeftDriveF = 0.90 / k_maxDriveSpeed; //0.90
  // / k_maxDriveSpeed;
  // private static final double k_backRightDriveF = 0.89 / k_maxDriveSpeed;
  // //0.92 / k_maxDriveSpeed;
  // private static final double k_frontRightDriveF = 0.90 / k_maxDriveSpeed;
  // //0.92 / k_maxDriveSpeed;
  ...
  // private static final double k_frontLeftSteeringP = 0.75 / 360;
  // private static final double k_backLeftSteeringP = 0.75 / 360;
  // private static final double k_backRightSteeringP = 0.75 / 360;
  // private static final double k_frontRightSteeringP = 0.75 / 360;
  ...
  // public static final double k_maxDriveSpeedMetersPerSecond = k_maxDriveSpeed /
  // k_ticksPerMeter;
  // public static final double k_maxAngularSpeed = 1.0; // radians / sec
  ...
  // private static final double k_frontLeftDriveF = 0.94 / k_maxDriveSpeed;
  // //0.92 / k_maxDriveSpeed;
  // private static final double k_backLeftDriveF = 0.90 / k_maxDriveSpeed; //0.90
  // / k_maxDriveSpeed;
  // private static final double k_backRightDriveF = 0.96 / k_maxDriveSpeed;
  // //0.92 / k_maxDriveSpeed;
  // private static final double k_frontRightDriveF = 0.96 / k_maxDriveSpeed;
  // //0.92 / k_maxDriveSpeed;
